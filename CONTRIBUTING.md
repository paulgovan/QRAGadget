...
This outlines how to propose a change to QRAGadget. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("paulgovan/QRAGadget", fork = TRUE)`.
...
Code of
Conduct](http://paulgovan.github.io/QRAGadget/CODE_OF_CONDUCT.md). By
